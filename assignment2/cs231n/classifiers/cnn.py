...
class ThreeLayerConvNet(object):
  ...
  def loss(self, X, y=None):
    ...
    # variable.                                                                #
    ############################################################################
    out_forward_1, cache_forward_1 = conv_relu_pool_forward(X, W1, b1, conv_param, pool_param)
    out_forward_2, cache_forward_2 = affine_relu_forward(out_forward_1, W2, b2)
    scores, cache_forward_3 = affine_forward(out_forward_2, W3, b3)
    ############################################################################
    #                             END OF YOUR CODE                             #
    ############################################################################
